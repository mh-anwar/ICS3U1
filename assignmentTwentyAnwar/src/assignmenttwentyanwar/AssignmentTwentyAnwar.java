 ...
 * @author s201076699
 */
public class AssignmentTwentyAnwar {
    ...
    public static void main(String[] args) {
        ...
        while(userExit == false){
            ...
            // Call sub-routine based on choice AND display result
            if(input==1){
                int areaOfTriangle = triangleArea();
                System.out.println("The area of the triangle is: " + areaOfTriangle);
            } else if(input==2){
                Double hypotenuseOfTriangle = triangleHypotenuse();
                System.out.println("The hypotenuse of the triangle is: " + hypotenuseOfTriangle);
            } else if(input==3){
                Double carSpeed = vehicleSpeed();
                System.out.println("The car speed is: " + carSpeed);
            } else if(input==4){
                String lineMidpoint = lineMidpoint();
                System.out.println("The midpoint of the line segment is: " + lineMidpoint);
            } else if(input==5){
                Double triangleMissingAngle = triangleMissingAngle();
                System.out.println("The missing angle is: " + triangleMissingAngle + " degrees");
            } else if(input==6){
                userExit = true;
            }
        }
    ...
    static Double triangleHypotenuse(){
    ...
    static String lineMidpoint(){
        ...
        String midpoint = Integer.toString(xValueMid) + ", " + Integer.toString(yValueMid);
    ...
    static Double triangleMissingAngle(){
