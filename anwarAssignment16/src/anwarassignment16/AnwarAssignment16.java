 ...
 */
// Will fail if user.csv and data.csv are not availible
public class AnwarAssignment16 {
    ...
    static void createPost(){
        ...
        try {
            ...
            Logger.getLogger(AnwarAssignment16.class.getName()).log(Level.SEVERE, null, ex);
        }
